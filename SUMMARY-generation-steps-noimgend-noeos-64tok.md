...
Generated: 2026-06-26T16:48:36+00:00

## Engines

- Reference: `sglang-native`
- Candidate: `llamacpp-q4_k_m-uocr-parity-debug-noimgend-noeos-64tok`
- Metrics CSV: `/tmp/uocr-step-results/compare/SUMMARY-generation-steps-noimgend-noeos-64tok.csv`
- Steps CSV: `/tmp/uocr-step-results/compare/SUMMARY-generation-steps-noimgend-noeos-64tok-steps.csv`
