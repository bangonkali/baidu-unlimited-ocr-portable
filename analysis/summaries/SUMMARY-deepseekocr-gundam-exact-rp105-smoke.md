...
- Reference: `sglang`
- Candidate: `llamacpp-q4_k_m-gundam-exact-rp105-prefix-tight`
- Metrics CSV: `results/compare/SUMMARY-deepseekocr-gundam-exact-rp105-smoke.csv`
...
- Average text similarity: 0.997
- Average reference elapsed: 1881 ms
- Average candidate elapsed: 3163 ms
