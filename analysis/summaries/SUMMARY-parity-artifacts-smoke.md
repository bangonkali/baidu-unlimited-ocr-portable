...
- Reference: `sglang`
- Candidate: `llamacpp-q4_k_m-uocr-parity-debug-smoke`
- Metrics CSV: `results/compare/SUMMARY-parity-artifacts-smoke.csv`
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|
| candidate_leading_whitespace_token | sc-02-45a8efac | document_parsing | <|det|> | 201 -> <|det|> | 201 | 0.000 | 0.000 | 128 | 128 |
