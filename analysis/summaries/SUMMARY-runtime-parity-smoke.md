...
Generated: 2026-06-26T16:05:54+00:00

## Engines

- Reference artifact engine: `sglang-processor`
- Candidate artifact engine: `llamacpp-q4_k_m-uocr-parity-debug-smoke`
- Metrics CSV: `results/compare/SUMMARY-runtime-parity-smoke.csv`
...
- Average candidate prefill delta vs SGLang processor input length: 2.000
...
|---|---|---|---:|---|---|
| candidate_extra_boundary_tokens | sc-02-45a8efac | document_parsing | 2 | `[0, 34030, 76466, 16]` | `[0, 201, 34030, 76466, 16, 1]` |
