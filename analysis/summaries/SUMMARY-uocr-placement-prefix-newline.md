...
Generated: 2026-06-26T13:00:56+00:00

## Engines

- Reference: `sglang`
- Candidate: `llamacpp-q4_k_m-uocr-placement-prefix-newline`
- Metrics CSV: `results/compare/SUMMARY-uocr-placement-prefix-newline.csv`
...
- Average text similarity: 0.615
- Average reference elapsed: 2125 ms
- Average candidate elapsed: 2826 ms
...
- `llamacpp-q4_k_m-uocr-placement-prefix-newline` needs more validation before packaging: non-empty outputs still show repetition or layout-marker mismatches.
...
|---|---|---|---:|---:|---:|---:|---:|---:|---|
| candidate_repetition | sc-02-45a8efac | grounding | 0.615 | 9 | 8 | 3067 | 0.519 | 2826 | dataset/sc-02.png |
