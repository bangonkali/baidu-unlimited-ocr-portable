...
Generated: 2026-06-26T13:01:00+00:00

## Engines

- Reference: `sglang`
- Candidate: `llamacpp-q4_k_m-uocr-placement-suffix-newline`
- Metrics CSV: `results/compare/SUMMARY-uocr-placement-suffix-newline.csv`
...
- Average text similarity: 0.764
- Average reference elapsed: 2125 ms
- Average candidate elapsed: 2817 ms
- Average reference GPU after request: 31686 MB
- Average candidate GPU after request: 1709 MB
- Average reference bbox markers: 9.000
- Average candidate bbox markers: 9.000

## Quality Finding

- `llamacpp-q4_k_m-uocr-placement-suffix-newline` needs more validation before packaging: non-empty outputs still show repetition or layout-marker mismatches.
...
|---|---|---|---:|---:|---:|---:|---:|---:|---|
| candidate_repetition | sc-02-45a8efac | grounding | 0.764 | 9 | 9 | 3079 | 0.429 | 2817 | dataset/sc-02.png |
