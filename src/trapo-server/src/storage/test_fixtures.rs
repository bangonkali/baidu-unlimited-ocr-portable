mod test_fixtures {
    ...
    pub(super) fn span(
        ...
        DiagnosticSpanInsert {
            ...
            status: status.to_string(),
            status_code: if error_message.is_some() { "error" } else { "ok" }.to_string(),
            status_message: error_message.map(str::to_string),
            started_at: "2026-07-03T00:00:00Z".to_string(),
            ended_at: "2026-07-03T00:00:01Z".to_string(),
            started_at_ms: 1_783_036_800_000,
            ended_at_ms: 1_783_036_801_000,
            duration_ms: 1000.0,
            attributes: json!({"page": page_no}),
            resource: json!({"service.name": "test"}),
            links: json!([]),
    ...
    pub(super) fn diagnostic_event(
        ...
        DiagnosticEventInsert {
            ...
            timestamp_ms: 1_783_036_801_000,
