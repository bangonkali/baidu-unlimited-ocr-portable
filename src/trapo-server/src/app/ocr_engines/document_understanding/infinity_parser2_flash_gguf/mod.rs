...
pub(in crate::app::ocr_engines) const ENGINE_ID: &str = "infinity-parser2-flash-gguf";
...
const SPEC: GgufVlmSpec = GgufVlmSpec {
    engine_id: ENGINE_ID,
    default_model_id: "infinity-parser2-flash-gguf",
...
pub(in crate::app::ocr_engines) const fn capability() -> RunnerCapability {
    RunnerCapability {
        ...
        status: "wired",
        detail: Some("uses llama-mtmd-cli with Infinity Parser2 Flash GGUF and mmproj assets"),
    }
}
