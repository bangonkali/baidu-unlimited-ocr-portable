#ifndef TRAPO_OCR_MODEL_OCR_MODEL_BUNDLE_HPP_
#define TRAPO_OCR_MODEL_OCR_MODEL_BUNDLE_HPP_
...
struct DocumentMarkdownBundleCheck {
  bool ok = false;
  std::string root;
  std::string manifest_path;
...
#endif  // TRAPO_OCR_MODEL_OCR_MODEL_BUNDLE_HPP_
