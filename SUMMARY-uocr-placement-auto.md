...
Generated: 2026-06-26T13:01:03+00:00

## Engines

- Reference: `sglang`
- Candidate: `llamacpp-q4_k_m-uocr-placement-auto`
- Metrics CSV: `results/compare/SUMMARY-uocr-placement-auto.csv`
...
- Average candidate elapsed: 1660 ms
- Average reference GPU after request: 31686 MB
- Average candidate GPU after request: 1674 MB
- Average reference bbox markers: 9.000
- Average candidate bbox markers: 0.000

## Quality Finding

- `llamacpp-q4_k_m-uocr-placement-auto` is not production-ready in this harness: most candidate rows are empty even though the process exits successfully.
...
|---|---|---|---:|---:|---:|---:|---:|---:|---|
| candidate_empty | sc-02-45a8efac | grounding | n/a | 9 | 0 | 0 | 0.000 | 1660 | dataset/sc-02.png |
