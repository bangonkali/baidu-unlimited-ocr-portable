...
- Reference: `sglang`
- Candidate: `llamacpp-q4_k_m-gundam-prefix-tight`
- Metrics CSV: `results/compare/SUMMARY-deepseekocr-gundam-smoke.csv`
...
- Average text similarity: 0.237
- Average reference elapsed: 1881 ms
- Average candidate elapsed: 6115 ms
- Average reference GPU after request: 31574 MB
- Average candidate GPU after request: 3614 MB
- Average reference bbox markers: 9.000
- Average candidate bbox markers: 8.000

## Quality Finding

- `llamacpp-q4_k_m-gundam-prefix-tight` needs more validation before packaging: non-empty outputs still show repetition or layout-marker mismatches.
...
|---|---|---|---:|---:|---:|---:|---:|---:|---|
| candidate_repetition | sc-02-45a8efac | document_parsing | 0.237 | 9 | 8 | 2289 | 0.530 | 6115 | dataset/sc-02.png |
